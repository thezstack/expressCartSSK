...
console.log(items);
    ...
    $('#paymentMessage').text('Thanks for shopping with us. Please reply back to this email if you have any questions or concerns!');
